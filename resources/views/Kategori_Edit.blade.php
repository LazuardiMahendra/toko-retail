...
<html lang="en">
  <head>
    ...
    <title>Employee ! | Edit Kategori </title>
                  ...
                  <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                      <div class="x_content">
                        ...
                        <form action="{{url('/employee/kategori/edit/post')}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        {{ csrf_field() }}
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">ID</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="id_kategori" value="{{ $id_kategori->id_kategori }}" required="required" class="form-control ">
                            </div>
                          </div>
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="nama_kategori" value="{{ $id_kategori->nama_kategori }}" required="required" class="form-control">
                            </div>
                          </div>
