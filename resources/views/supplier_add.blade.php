...
<html lang="en">
  <head>
    ...
    <title>Employee ! | Tambah Supplier </title>
                  ...
                  <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                      <div class="x_content">
                        ...
                        <form action="{{url('/employee/supplier/add/post')}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        {{ csrf_field() }}
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">ID</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="id_supplier" required="required" class="form-control ">
                            </div>
                          </div>

                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Nama </label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="nama_supplier" required="required" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="email_supplier" required="required" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="no_supplier" required="required" class="form-control">
                            </div>
                          </div>

                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Kecamatan </label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="kecamatan_supplier" required="required" class="form-control">
                            </div>
                          </div>

                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Kabupaten/Kota </label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="kota_supplier" required="required" class="form-control">
                            </div>
                          </div>

                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Provinsi </label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="provinsi_supplier" required="required" class="form-control">
                            </div>
                          </div>

                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Kode Pos</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="kodepos_supplier" required="required" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <textarea type="text" name="alamat_supplier" required="required" class="textarea form-control" ></textarea>
                            </div>
                          </div>
