...
<html lang="en">
  <head>
    ...
    <title>Employee ! | Tambah Produk </title>
                  ...
                  <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                      <div class="x_content">
                        ...
                        <form action="{{url('/employee/produk/add/post')}}" enctype="multipart/form-data" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        {{ csrf_field() }}
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">ID</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="id_produk" required="required" class="form-control ">
                            </div>
                          </div>
                          ...
                          <div class="field item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input class="form-control" class='date' type="date" name="tgl_masuk" required='required'></div>
                          </div>
