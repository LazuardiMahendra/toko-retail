...
<html lang="en">
  <head>
    ...
    <title>Employee ! | Edit Produk </title>
                  ...
                  <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                      <div class="x_content">
                        ...
                        <form action="{{url('/employee/produk/edit/post')}}" enctype="multipart/form-data" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        {{ csrf_field() }}
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">ID</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="id_produk" value="{{ $id_produk->id_produk }}" required="required" class="form-control ">
                            </div>
                          </div>

                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Nama Produk</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="nama_produk" value="{{ $id_produk->nama_produk }}" required="required" class="form-control">
                            </div>
                          </div>

                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Harga Produk</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="harga" value="{{ $id_produk->harga }}" required="required" class="form-control">
                            </div>
                          </div>

                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Stok Produk</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="stok" value="{{ $id_produk->stok }}" required="required" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <select type="text" name="id_kategori" class="select2_single form-control" tabindex="-1">
                                            @foreach($t_kategori as $k)
                                                        <option 
                                                            value="{{$k->id_kategori}}"
                                                            @if ($k->id_kategori=== $id_produk->id_kategori)
                                                            selected
                                                            @endif >
                                                            {{$k->nama_kategori}}
                                                        </option>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <select type="text" name="id_supplier" class="select2_single form-control" tabindex="-1">
                                            @foreach($t_supplier as $s)
                                                        <option 
                                                            value="{{$s->id_supplier}}"
                                                            @if ($s->id_supplier === $id_produk->id_supplier)
                                                            selected
                                                            @endif >
                                                            {{$s->nama_supplier}}
                                                        </option>
                          ...
                          <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Foto</label>
                            <div class="col-md-6 col-sm-6 ">
                                <input type="file" name="file" value="{{$id_produk->foto}}">
                            </div>
                          </div>
                          ...
                          <div class="field item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <input class="form-control" class='date' value="{{ $id_produk->tgl_masuk }}" type="date" name="tgl_masuk" required='required'></div>
                          </div>
