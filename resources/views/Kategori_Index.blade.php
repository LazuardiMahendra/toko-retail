                    ...
                    <div class="x_content">
                      ...
                      <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                        ...
                        @foreach($id_kategori as $k)
                                <tr>
                                    <td><center>{{ $k->id_kategori }}</td>
                                    <td><center>{{ $k->nama_kategori }}</td>
                                    <td><center><a href="{{url('/employee/kategori/edit/'.$k->id_kategori)}}" class="btn btn-warning"><i class="fa fa-edit"></a></td></center>
                                    <td><center><a href="{{url('/employee/kategori/delete/'.$k->id_kategori)}}" class="btn btn-danger"><i class="fa fa-trash"></a></td></center>
                                </tr>
						@endforeach 
                        </tbody>
                        </table>
                        <a href="/employee/kategori/add/post" class="btn btn-info">+ Tambah Kategori</a>
