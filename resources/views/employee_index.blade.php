  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <!-- page content -->
        <div class="right_col align-items-center half-screen space" role="main">
                      <div class="col-sm-12 profile_details">
                        <div class="col-sm-12 well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>Data User</i></h4>
                            <div class="left col-md-12 col-sm-12">
                              <p><strong>ID: </strong> {{$session['id_user']}} </p>
                              <h2><strong>Nama: </strong>{{$session['nama_user']}}</h2>
                              <p><strong>Status: </strong> {{$session['status']}} </p>
                              <ul class="list-unstyled">
                                <li><i class="fa fa-email"></i> Email: {{$session['email']}}</li>
                                <li><i class="fa fa-phone"></i> Phone #: {{$session['hp']}}</li>
                              </ul>
                            </div>
                          </div>
